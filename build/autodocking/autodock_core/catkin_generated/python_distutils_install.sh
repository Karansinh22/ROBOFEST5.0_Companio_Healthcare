...
echo_and_run cd "/root/BumbleBot_WS/src/autodocking/autodock_core"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/BumbleBot_WS/src/autodocking/autodock_core/setup.py" \
    egg_info --egg-base /root/BumbleBot_WS/build/autodocking/autodock_core \
    build --build-base "/root/BumbleBot_WS/build/autodocking/autodock_core" \
    install \
    --root="${DESTDIR-/}" \
